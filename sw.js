...
const CACHE_NAME = 'ske-truck-dev-v31-reconnect-logo-v3';
const OLD_DEV_CACHES = new Set([
  'ske-truck-dev-v31-reconnect-logo-v1',
  'ske-truck-dev-ske-truck-dev-v31-reconnect-logo-v2',
  'ske-truck-dev-v31-reconnect-logo-v2',
  'ske-truck-dev-handoff-v1'
]);

// เก็บเฉพาะไฟล์ static ที่รู้แน่ ๆ เท่านั้น
const STATIC_ASSETS = [
  './manifest.json?v=dev-v31-reconnect-logo-v3',
  './icon-192.png',
  './icon-512.png',
  './ske-logo.png'
];
