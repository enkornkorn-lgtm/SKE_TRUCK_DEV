// SKE TRUCK Unified Service Worker V7
const CACHE_PREFIX = 'ske-truck-';
const CACHE_NAME = CACHE_PREFIX + 'v7-20260725';
const STATIC_ASSETS = ['./manifest.json?v=7', './icon-192.png', './icon-512.png', './ske-logo.png'];
